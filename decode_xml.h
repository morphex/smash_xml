...
unicode_char_length find_processing_instruction_end(CONST unicode_char *buffer,unicode_char_length offset);
unicode_char_length find_element_endtag(CONST unicode_char *buffer,unicode_char_length offset);
